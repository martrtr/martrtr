...
print('===MAIN_WINDOWS_GO===')
print(Path('main_windows.go').read_text())
print('===NET_GO===')
print(Path('net.go').read_text())
print('===MIC_WINDOWS_GO===')
print(Path('mic_windows.go').read_text())
print('===END_WINDOWS_SOURCE===')
